    ...
    <Card>
      ...
      <form onSubmit={handleSignup} className="spaceSubItems">
        ...
        <Input
          ...
          onChange={(e) => {setConfirmPassword(e.target.value);  setError(password===confirmPassword)}}
          placeholder="Confirm password"
          isInvalid={isError}
          errorMessage="Passwords are not corresponding"
        />
        <Button type="submit" color="success" className="centeredText font-bold">Confirm</Button>
      </form>
      </CardBody>
      <CardFooter>
